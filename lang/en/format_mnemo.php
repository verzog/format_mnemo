...
$string['cameranav'] = 'Camera navigation';
...
$string['cameranav_hint_pose'] = 'Open palm to stop, move your hand left or right to steer, make a fist and pull it toward you to go forward.';
...
$string['comfortfull'] = 'Full';
$string['comfortglide'] = 'Glide';
$string['comfortlight'] = 'Light';
$string['comfortmovement'] = 'Moving in VR';
$string['comfortnormal'] = 'Normal';
$string['comfortoff'] = 'Off';
$string['comfortslow'] = 'Slow';
$string['comfortspeed'] = 'Movement speed';
$string['comfortteleport'] = 'Teleport';
$string['comfortturn'] = 'Turning';
$string['comfortturnsmooth'] = 'Smooth';
$string['comfortturnsnap'] = 'Snap';
$string['comfortvignette'] = 'Motion vignette';
...
$string['game'] = 'Arcade game mode';
$string['game_help'] = 'Adds an optional shoot-the-targets mini-game to the 3D view, launched from a button in the scene. It is off by default and has no effect on normal course browsing or the list view.';
$string['gameexit'] = 'Exit game';
$string['gamehealth'] = 'Shields';
$string['gamehint'] = 'Aim with the crosshair and click (or squeeze the trigger in VR) to shoot the targets.';
$string['gameover'] = 'Game over';
$string['gamescore'] = 'Score';
...
$string['lighting'] = 'Street lighting';
$string['lighting_dense'] = 'Dense';
$string['lighting_help'] = 'How densely street lamps line the avenue and side streets. Lamps are spaced evenly and a lamp stands at each side-street corner; denser lighting places them closer together. Off removes the automatic street lamps (teachers can still place their own). Site default uses the site-wide setting.';
$string['lighting_inherit'] = 'Site default';
$string['lighting_normal'] = 'Normal';
$string['lighting_off'] = 'Off';
$string['lighting_sparse'] = 'Sparse';
...
$string['preview_beh_avoid'] = 'Avoids buildings';
$string['preview_beh_face'] = 'Faces travel direction';
$string['preview_beh_grounded'] = 'Drives on the ground';
$string['preview_beh_takeoffland'] = 'Takes off and lands';
$string['preview_behaviour'] = 'Behaviour';
$string['preview_copyright'] = 'Copyright: {$a}';
$string['preview_dir_0'] = 'North (0°)';
$string['preview_dir_180'] = 'South (180°)';
$string['preview_dir_270'] = 'West (270°)';
$string['preview_dir_90'] = 'East (90°)';
$string['preview_dir_auto'] = 'Auto';
$string['preview_direction'] = 'Facing';
$string['preview_environments'] = 'Environments';
$string['preview_environments_help'] = 'Which environments this model appears in. Leave all unticked to allow it everywhere.';
$string['preview_generator'] = 'Generator: {$a}';
...
$string['preview_procedural'] = 'Not set — procedural default';
$string['preview_ringmarked'] = 'Ringed (filename contains "ring")';
$string['preview_save'] = 'Save model settings';
$string['preview_saved'] = 'Saved settings for {$a}.';
$string['preview_scale'] = 'Scale';
$string['preview_scale_help'] = 'Size multiplier applied when this model is placed (0.1–10). Leave blank for the model\'s own size.';
$string['preview_source_bundled'] = 'Bundled default';
$string['preview_source_none'] = 'Not set';
$string['preview_source_uploaded'] = 'Uploaded';
$string['preview_source_url'] = 'From URL';
$string['preview_tex_groundtexture'] = 'Ground texture';
$string['preview_tex_planet'] = 'Planet map {$a}';
$string['preview_tex_ringtexture'] = 'Planet ring texture';
$string['preview_tex_roadtexture'] = 'Road texture';
$string['preview_tex_sidewalktexture'] = 'Sidewalk texture';
$string['preview_tex_signtexture'] = 'Sign frame texture';
$string['preview_tex_spacetexture'] = 'Space background';
$string['preview_textures'] = 'Textures';
$string['preview_title'] = 'Asset viewer';
$string['preview_use_groundtexture'] = 'Tiled across the ground plazas around buildings.';
$string['preview_use_planet'] = 'Wraps one of the Void\'s planets.';
$string['preview_use_ringtexture'] = 'Skins the rings of ringed planets in the Void.';
$string['preview_use_roadtexture'] = 'Tiled across every road surface.';
$string['preview_use_sidewalktexture'] = 'Laid over the raised sidewalks along the avenue.';
...
$string['setting_cameranav'] = 'Camera gesture navigation';
$string['setting_cameranav_desc'] = 'Offer flat-screen (non-VR) learners an opt-in control that uses their webcam to steer and move by hand gestures. The webcam is used only when the learner turns it on, is processed on the device, and is never uploaded or recorded. Untick to remove the control site-wide.';
$string['setting_cartypes'] = 'Flying-car types';
$string['setting_cartypes_desc'] = 'Define the flying-car traffic, one car type per line, as <code>model | path | speed | height | land | count | yaw</code> (<code>count</code> and <code>yaw</code> are optional). <ul><li><strong>model</strong> — a placeable prop name (bundled or uploaded, e.g. <code>av</code>); named building models are not allowed.</li><li><strong>path</strong> — <code>avenue</code>, <code>cross</code> or <code>diagonal</code>. Cars now roam to random destinations and rise over buildings automatically, so this field is kept only for compatibility and no longer sets a fixed direction.</li><li><strong>speed</strong> — world units per second (1–60).</li><li><strong>height</strong> — the car\'s cruising altitude band in world units (4–60); some cars fly low over the streets and some high over the rooftops around this.</li><li><strong>land</strong> — <code>none</code> (cruise only), <code>ground</code> (dip to street level and climb back), or <code>rooftop</code> (dip to rooftop level and climb back).</li><li><strong>count</strong> — how many of this car to spawn (1–16; default 4).</li><li><strong>yaw</strong> — optional facing in degrees, added to the travel direction. Leave it off and the model is auto-oriented to point the way it travels; set it (e.g. <code>90</code>, <code>-90</code> or <code>180</code>) only if a particular model still faces the wrong way.</li></ul>Blank lines and lines starting with <code>#</code> are ignored; lines that are malformed or name an unknown model are skipped. Left blank, a single fleet of avenue vehicles flies as before. Example:<pre>av | avenue | 14 | 20 | none | 8
av | cross | 10 | 26 | rooftop | 4
hovercar | diagonal | 18 | 16 | ground | 3 | 180</pre>';
...
$string['setting_defaultlighting'] = 'Default street lighting';
$string['setting_defaultlighting_desc'] = 'The street-lamp density applied to courses that inherit the site default. Teachers can override this per course.';
...
$string['setting_planettextures_desc'] = 'Upload up to nine equirectangular (2:1 lat-long) images to use as the surfaces of the planets in the Void environment. Each image is applied to one planet, in filename order. Some of the Void\'s planets are ringed by default; include the word "ring" in a file\'s name (for example "saturn-ring.png") to add a ring to that planet as well. Leave empty to keep the procedural planets. Only used in the Void environment.';
$string['setting_ringtexture'] = 'Upload ring texture';
$string['setting_ringtexture_desc'] = 'Upload an image to skin the rings of ringed planets in the Void environment, as an alternative to hosting it at a URL above. Leave both blank to use a plain banded ring. Uploaded files are used only when the URL above is blank.';
$string['setting_ringtextureurl'] = 'Ring texture URL';
$string['setting_ringtextureurl_desc'] = 'URL of a ring image for the Void\'s ringed planets: a radial strip read from the inner edge (left) to the outer edge (right) and wrapped once around the ring, so it reads as concentric bands. Some of the Void\'s planets are ringed by default; an uploaded planet is additionally ringed when its filename contains the word "ring". Leave this blank to upload an image below or to keep the plain banded ring. If set, this URL takes precedence over any uploaded image. A hosted image must allow cross-origin use (its server needs a permissive CORS policy), and your site\'s content security policy must allow the image source.';
...
$string['setting_spacetexture'] = 'Upload space background';
$string['setting_spacetexture_desc'] = 'Upload an equirectangular (2:1 lat-long) sky or starfield image to wrap around the Void environment as its backdrop, as an alternative to hosting it at a URL above. Leave both blank to keep the procedural starfield and nebulae. Only used in the Void environment. Uploaded files are used only when the URL above is blank.';
$string['setting_spacetextureurl'] = 'Space background URL';
$string['setting_spacetextureurl_desc'] = 'URL of an equirectangular (2:1 lat-long) sky or starfield image wrapped around the Void environment as its backdrop. Leave this blank to upload one below or to keep the procedural starfield. If set, this URL takes precedence over any uploaded image. A hosted image must allow cross-origin use (its server needs a permissive CORS policy), and your site\'s content security policy must allow the image source.';
$string['setting_threeurl'] = 'Three.js module URL';
$string['setting_threeurl_desc'] = 'URL of the Three.js ES module used to render the 3D scene. Leave this blank to use the copy bundled with the plugin. Set it only to load Three.js from a shared or newer hosted copy; it must be an ES module build of <code>three.module.min.js</code>. Note: the bundled glTF loader stack (with the Draco/meshopt/KTX2 decoders for compressed models) is version-matched to the bundled Three.js, so it is used only when this override is blank. With an override set, compressed models fall back to the built-in uncompressed-glTF parser.';
