...
$string['cameranav_hint_pose'] = 'Turn your head to steer left or right, open your palm to stop, and make a fist and pull it toward you to go forward.';
...
$string['fly'] = 'Fly';
$string['fly_help'] = 'Fly freely instead of walking on the ground. Off by default, so you stay on the ground until you turn it on.';
...
$string['gamehint'] = 'Move the mouse to aim and click to fire (or squeeze the trigger in VR). Click the scene to lock the mouse, and press Esc to release it. With camera navigation, aim with your head and make a finger gun, then drop your thumb, to shoot.';
...
$string['keybindback'] = 'Back';
$string['keybinddown'] = 'Down';
$string['keybindfire'] = 'Fire';
$string['keybindfireleft'] = 'Left click';
$string['keybindfireright'] = 'Right click';
$string['keybindforward'] = 'Forward';
$string['keybindhint'] = 'Click a key, then press the new key. In the arcade, move the mouse to aim and click to fire.';
$string['keybindinvert'] = 'Invert look';
$string['keybindleft'] = 'Left';
$string['keybindlook'] = 'Look sensitivity';
$string['keybindlookhigh'] = 'High';
$string['keybindlooklow'] = 'Low';
$string['keybindlooknormal'] = 'Normal';
$string['keybindoff'] = 'Off';
$string['keybindon'] = 'On';
$string['keybindpress'] = 'Press a key…';
$string['keybindreset'] = 'Reset';
$string['keybindright'] = 'Right';
$string['keybindrun'] = 'Run';
$string['keybinds'] = 'Controls';
$string['keybindup'] = 'Up / jump';
...
$string['privacy:metadata:preference:keybinds'] = 'The learner\'s Mnemo desktop control mapping: movement keys, the fire mouse button, look sensitivity and whether look is inverted.';
