...
$string['setting_assetbaseurl_desc'] = 'Base URL of a directory of glTF (<code>.glb</code>) prop models (av, lamp, kiosk, barrier, …). Leave this blank to upload a pack below or to use the original props bundled with the plugin. Set it to point at your own CC0/licensed asset pack hosted elsewhere; the models must be uncompressed glTF (no Draco compression). If set, this URL takes precedence over any uploaded pack.';
$string['setting_assetpack'] = 'Upload prop asset pack';
$string['setting_assetpack_desc'] = 'Upload your own glTF (<code>.glb</code>) prop models directly into Moodle, as an alternative to hosting them at a URL above. Name each file for the prop it replaces — <code>av.glb</code> (flying car), <code>lamp.glb</code> (street lamp), <code>kiosk.glb</code> (street kiosk) and <code>barrier.glb</code> (road barrier). Models must be uncompressed glTF (no Draco compression); textures may be embedded in the <code>.glb</code>. Uploaded files are used only when the URL above is blank.';
