...
$string['setting_planettextures_desc'] = 'Upload up to nine equirectangular (2:1 lat-long) images to use as the surfaces of the planets in the Void environment. Each image is applied to one planet, in filename order. Leave empty to keep the procedural planets. Only used in the Void environment.';
