...
$string['setting_assetbaseurl_desc'] = 'Base URL of a directory of glTF (<code>.glb</code>) prop models (av, lamp, kiosk, barrier, …). Leave this blank to use the original props bundled with the plugin. Set it to swap in your own CC0/licensed asset pack; the models must be uncompressed glTF (no Draco compression).';
